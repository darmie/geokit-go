An assortment of geolocation related tools, all packaged in one easy to use kit. A direct port from [MichaelSolati/geokit]("https://github.com/MichaelSolati/geokit")
